...
# Documentation
An in-depth API documentation, including interactive code examples and extensive descriptions can be found at [https://www.userparser.com/docs/user-agent-parser-api-documentation-v1.0.0](https://www.userparser.com/docs/user-agent-and-geoip-lookup-api-v1.0.1)
## PHP code Example
```php
